...
namespace Posts.Infrastructure.Repositories
{
    ...
    {
        public PostViewsRepository(IDbConnectionFactory connectionFactory, ICurrentUser currentUser) : base(connectionFactory, currentUser)
        {
        }
        ...
        protected override ColumnDefinition[] Columns => new [] {
            ...
            new ColumnDefinition { PropertyName = nameof(PostView.LastViewedAt), ColumnName = "last_viewed_at" },
        };
    }
}
